...
**Note that the UserData script on an EC2 instance does not re-run when an EC2 instance is restarted, only when it is first launched. If you are making changes to your trainer-script file, you'll need to delete your CloudFormation stack before launching it again.** 
